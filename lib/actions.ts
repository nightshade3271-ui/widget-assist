...
export async function updateWidget(id: string, formData: FormData) {
    const data: any = {}
    const fields = ['name', 'companyName', 'description', 'welcomeMessage', 'systemPrompt', 'primaryColor', 'secondaryColor', 'avatarUrl', 'bannerUrl', 'leadFormMessage', 'leadKeywords', 'openRouterKey']
